// non jQuery
	...
	function login(){ 
		...
		if(getusername == "guest" || getusername == "GUEST" && getpassword === "guest12345"){
			...
			document.location.href = "Tubes203040037(login).html";
	...
	function logout(){
		document.location.href = "Tubes203040037(logout).html";
	}
	...
	function uploadportofolio(aksi){
		if(aksi === "login"){
			...
			document.location.href = "Tubes203040037(uploadportofolio).html";
		}
	}
// end none jQuery
